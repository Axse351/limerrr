    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>SCANNER1 WAHANA ajsj</h1>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-warning">
                            <img src="{{ asset('img/p1.png') }}" alt="" height="60px">
                        </div>
                        <div class="card-wrap">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-danger">
                            <img src="{{ asset('img/p2.png') }}" alt="" height="60px">
                        </div>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h3>Produksi</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-danger">
                            <img src="{{ asset('img/p3.png') }}" alt="" height="50px">
                        </div>
                        <div class="card-wrap">
                            <div class="card-header">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        <div class="card-icon bg-dark">
                            <img src="{{ asset('img/p4.png') }}" alt="" height="60px">
                        </div>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h3>Laporan</h3>
