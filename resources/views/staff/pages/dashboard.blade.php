                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="150"
                                        src="{{ asset('img/avatar/food1.png') }}" alt="avatar">
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="150"
                                        src="{{ asset('img/avatar/food2.png') }}" alt="avatar">
                                        <div class="media-body">
                                            <div class="text-primary float-right">Now</div>
                                            <div class="media-title">Farhan A Mujib</div>
                                            <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="150"
                                        src="{{ asset('img/avatar/food3.png') }}" alt="avatar">
                                        <div class="media-body">
                                            <div class="text-primary float-right">Now</div>
                                            <div class="media-title">Farhan A Mujib</div>
                                            <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="150"
                                        src="{{ asset('img/avatar/food4.png') }}" alt="avatar">
                                        <div class="media-body">
                                            <div class="text-primary float-right">Now</div>
                                            <div class="media-title">Farhan A Mujib</div>
                                            <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla.
